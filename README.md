...
A função del_lexer libera a memória do source internamente. Por isso, o source passado para init_lexer deve ser alocado com malloc e não deve ser liberado manualmente depois de del_lexer.